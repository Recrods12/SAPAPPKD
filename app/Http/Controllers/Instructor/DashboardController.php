...
class DashboardController extends Controller
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        return Inertia::render('instructor/dashboard', ['classes' => $classes, 'stats' => ['classes' => $classes->count(), 'participants' => $classes->sum('enrollments_count'), 'presentToday' => (clone $todayAttendance)->distinct()->count('user_id'), 'needsReview' => (clone $todayAttendance)->where('needs_review', true)->count()]]);
    }
}
